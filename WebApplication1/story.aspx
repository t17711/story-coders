<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="story.aspx.cs" Inherits="WebApplication1.story" %>
<!DOCTYPE html>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Pick a Story</a>
            </div>
   ...
   <section id="UserInfo">
            <div class="container">
                <div class="column">
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <a href="game.aspx" class="portfolio-link" data-toggle="modal">
                            <img src="img/sprite.png" class="img-responsive" alt="" height="300px" width="300px">
                        </a>
                    </div>
                    <div class="col-sm-4 portfolio-item">
                        <a href="#" class="portfolio-link" data-toggle="modal">
